	...
	return (
		<div {...rest}>
			<div
				...
				className="group flex py-2 px-3 space-x-2 data-[variant=info]:bg-sky-100 data-[variant=note]:bg-slate-50 data-[variant=warning]:bg-amber-100 data-[variant=error]:bg-red-100/50 border data-[variant=info]:border-sky-300 data-[variant=warning]:border-yellow-300 data-[variant=error]:border-red-200 rounded"
			>
